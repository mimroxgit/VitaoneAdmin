...
@Component({
  selector: 'app-practitioners-edit',
  templateUrl: './practitioners-edit.component.html',
  styleUrls: ['./practitioners-edit.component.css']
})
export class PractitionersEditComponent {
  ...
  onState(id: any) {
    ...
    if(id=="-"){
     ...
     this.stateId = id     
    //this.practitionersService.practitioners.stateId = id;
   // this.stateId = this.practitionersService.practitioners.stateId;
  }
  ...
  getPractitioners(id: any) {
    ...
    this.practitionersService.getPractitioners(id).subscribe({
      next: (data: any) => {           
        ...
        this.pcmName = data.pcmName;
        this.pcmSlug = data.pcmSlug;
        this.pcmClinicName = data.pcmClinicName;
        this.pcmContactNo = data.pcmContactNo;
        this.pcmEmail = data.pcmEmail;
        this.pcmPassword = data.pcmPassword;
        //this.stateId = data.stateId;
        //this.cityId = data.cityId;    
        //this.pcmAddress = data.pcmAddress;
        this.pcmIsActive = data.pcmIsActive;        
        this.pcmIsDefault = data.pcmIsDefault;
  ...
  onSubmit(form: NgForm) {
    ...
    if (this.errorCount == 0) {
      ...
      this.practitionersService.practitioners.id = this.Id;
      ...
      this.practitionersService.practitioners.groupId = this.groupId;
      this.practitionersService.practitioners.categoryId = this.categoryId;    
      ...
      if (this.loading == false) {
        ...
        this.practitionersService.editPractitioners().subscribe((res:any) => {
          this.response = res;
