...
@Component({
  selector: 'app-divplist',
  templateUrl: './divplist.component.html',
  styleUrls: ['./divplist.component.css']
})
export class DivplistComponent {


  tableThlist2= ['Product Name','HSN Code : ','SAC Code :']
  tableTdlist = ['name','hsnCode','sacCode']
